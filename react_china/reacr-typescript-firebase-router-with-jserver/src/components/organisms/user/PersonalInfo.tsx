      ...
      <div className="flex flex-col w-72 m-2 px-4 gap-1 shadow-xl rounded md:w-full max-w-4xl md:flex-row">
        <div className="flex flex-row md:w-32">
          <div className="w-1/2 md:w-full">
            <img
              src={user?.user_icon ?? "https://placehold.jp/150x150.png"}
            ...
            <div className="flex flex-col justify-center w-full md:w-4/5 text-xl gap-4">
              ...
              <div className="flex flex-row flex-wrap gap-y-2">
                {user?.user_tags?.map((tag, i) => (
                  <>
                    <span className="mx-2 px-4 py-1 rounded-lg bg-orange-500 font-bold text-white ring-2 ring-orange-200 text-sm">
            ...
            <div className="w-1/2">
              ...
              <div>
                <div className="w-full flex justify-start items-center">
                  ...
                  <span>{user?.user_email ?? "ry-tanaka@sios.com"}</span>
                </div>
                <div className="w-full flex justify-start items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>{user?.user_instagramid ?? "@dtrz0711"}</span>
                </div>
                <div className="w-full flex justify-start items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>{user?.user_twitterid ?? "@Rena_birds"}</span>
                </div>
                <div className="w-full flex justify-start items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span>{user?.user_facebookid ?? "@dtrz0711"}</span>
                </div>
              </div>
            </div>
            <div className="w-3/4 flex justify-center items-center">
              <img
                src={user?.user_lineqr ?? "https://placehold.jp/150x150.png"}
                alt=""
